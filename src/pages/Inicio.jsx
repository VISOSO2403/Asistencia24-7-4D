          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4 ">
            <div className="pt-32 sm:pt-0 "> 
              ...
              <div className="mt-12">
                <Link
                  to="/Login"
                  className="get-started text-white font-bold px-6 py-4 hover:bg-white hover:text-slate-800 hover: rounded outline-none focus:outline-none mr-1 mb-1 bg-lightBlue-500 active:bg-lightBlue-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                >
                  Iniciar sesión
                </Link>
                <Link
