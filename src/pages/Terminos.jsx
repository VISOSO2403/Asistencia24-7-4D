...
const Terminos = () => {
  return (
    ...
    <hr/>
      ...
      <h1 className='text-white font-bold text-center'>III. ACCESO Y NAVEGACIÓN EN EL SITIO WEB</h1>
        <p className='text-white'>  
    ...
    <hr/>
      ...
      <h1 className='text-white font-bold text-center'>IV. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h1>
        <p className='text-white'>   
    ...
    <hr/>
      ...
      <h1 className='text-white font-bold text-center'>V. POLÍTICA DE ENLACES</h1>
        <p className='text-white'>  
    ...
    <hr/>
      ...
      <h1 className='text-white font-bold text-center'>VI. POLÍTICA DE PROPIEDAD INTELECTUAL E INDUSTRIAL</h1>
        <p className='text-white'>  
    ...
    <hr/>
      ...
      <h1 className='text-white font-bold text-center'>VII. LEGISLACIÓN Y JURISDICCIÓN APLICABLE</h1>
        <p className='text-white'>
